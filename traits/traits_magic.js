...
const MAGIC_STATS = {
  ...
  elem_healing: { arcana: 5, medicine: 4, wisdom: 3, religion: 2, charisma: 1 }
};

const MAGIC_FLAVOR = {
  magic_affinity: '{name} was blessed with the ability to communicate with the arcana, with enough patience and practice they can learn to weave spells.',
  talented_mage: '{name} has a gift that goes beyond study or practice.',
  ...
  elem_fire: '{name} commands fire. Not in the reckless sense, but in the way of someone who has spent time with flame and learned to respect the line between controlled and catastrophic.',
  ...
  elem_magma: '{name} commands where earth and fire collide, unleashing molten stone and geological fury. It is not subtle. It was never meant to be.',
  ...
  elem_nature: '{name} works the deep harmony between earth and water, through growth, restoration, and the long patience of living things. Nature magic does not hurry. Neither does {name}.',
  elem_light: '{name} channels light, not merely illumination but radiant energy at its purest. It is the foundation from which healing flows, and those who wield it are rarely ordinary in any sense.',
  elem_dark: '{name} has chosen the exclusive path of darkness. Shadow, depth, and the things that live beyond ordinary sight: this is a solitary road. Dark magic tolerates no companions in the arcane.',
  elem_healing: '{name} has achieved something few ever reach: the merging of Light and Water into the art of Healing. It is not a passive gift. It is a profound command over life itself, drawing on pure radiance and the deep flow of water to mend what the world breaks.'
};
